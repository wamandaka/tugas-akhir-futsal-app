                        ...
                        <?php foreach ($role as $r) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url() ?>admin/updaterole/<?= $r['id'] ?>" class="badge badge-success" data-toggle="modal" data-target="#editRoleModal">edit</a>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/role') ?>" method="post">
                <div class="modal-body">
                    <div class="mb-3">
                        <input type="text" class="form-control" id="role" name="role" placeholder="Type new role">
                    </div>
                </div>
